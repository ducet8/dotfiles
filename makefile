...
AUTH_KEY_ED_CB := "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMqkPIMPM/70mM7XBc5D504LevhTEsFXDQAxM8na6pTb"
C_CYAN := \033[36m
C_GREEN := \033[32m
C_MAG := \033[35m
C_RED := \033[31m
...
.PHONY: bd
bd:  ## Clones bash.d
	@if [ -L "$(HOMEDIR)/etc" ]; then \
		git clone https://github.com/bash-d/bd $(HOMEDIR)/.bd; \
		echo "$(C_GREEN)Cloned bd to $(HOMEDIR)/.bd"; \
	fi	
